...
export default function AlertCard({ order }) {
  return (
    ...
    >
      <article className="grain-overlay relative overflow-hidden rounded-2xl border border-red-300 bg-[linear-gradient(160deg,#fff1f2,#ffe4e6)] p-4 shadow-sm transition group-hover:-translate-y-0.5 group-hover:shadow-md">
